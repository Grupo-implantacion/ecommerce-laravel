		...
		<div class="row align-items-center py-3 d-none d-lg-flex justify-content-between">
			<div class="col-lg-4 logo">
				<a href="index.php" class="text-decoration-none">
					<span class="h1 text-uppercase text-primary bg-dark px-2">Tienda</span>
	...
	<div class="container">
		<nav class="navbar navbar-expand-xl" id="navbar">
			<a href="index.php" class="text-decoration-none mobile-logo">
				<span class="h2 text-uppercase text-primary bg-dark">TIENDA</span>
				<span class="h2 text-uppercase text-white px-2">ONLINE</span>
			</a>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3">
                            <h1 class="display-4 text-white mb-3">Tina Creativa</h1>
                            <p class="mx-md-5 px-5">Tienda online de papeleria</p>
                            <a class="btn btn-outline-light py-2 px-4 mt-3" href="#">Compra Ahora</a>
                        </div>
                    </div>
                </div>
